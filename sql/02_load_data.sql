/* =====================================================================
   02_load_data.sql
   Loads the processed CSVs (data/processed/*.csv) into lending.* tables.
...
WITH (FORMAT = 'CSV', FIRSTROW = 2, TABLOCK, CODEPAGE = '65001', ROWTERMINATOR = '0x0a');
...
SELECT 'Branches' AS TableName, COUNT(*) AS RowCount FROM lending.Branches
